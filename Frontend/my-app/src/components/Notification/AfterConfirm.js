        ...
        <div>
          {
            <div className="reservation-message" key={data.id}>
              <p>
                Muchas gracias {operatorData.name} {operatorData.last_name} por confirmar las dimensiones del paquete.
              </p>

              <p> 
                El casillero en el que debes depositar el paquete es el locker '{lockerData.nickname}' de la estación ubicada en {lockerStationData.address},{lockerStationData.city}. Para cargar el paquete necesitaras el siguiente codigo '{data.reservation_code}'.
              </p>

              <p> 
                Tambien te notificaremos al correo con la informacion necesaria para depositar el paquete. 
              </p>
